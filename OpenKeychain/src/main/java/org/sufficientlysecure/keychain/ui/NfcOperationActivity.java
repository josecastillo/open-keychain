    ...
    protected void onNfcPerform() throws IOException {
        ...
        switch (mRequiredInput.mType) {
            ...
            case NFC_KEYTOCARD: {
                ...
                // Is this a hack? Need to communicate the card's serial number back to the process
                // that initiated the keytocard operation; this is using the cryptoData hashmap,
                // even though it has nothing to do with signing hashes or decrypting keys.
